...
for dataset in all_dataset_f.keys():
    ...
    if dataset=='book':
        ...
        df_s['reviewText'] = df_s['reviewText'].progress_apply( lambda x:x.split() )
        print("split -> reviewText")
        df_s['reviewText'] = df_s['reviewText'].progress_apply( lambda x:set(x) )
        print("set -> reviewText")
        df_s['reviewText'] = df_s['reviewText'].progress_apply( lambda x:x & vocab_dict )
    else:
        print("TFIDF finished")
